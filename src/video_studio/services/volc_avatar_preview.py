...
class VolcAvatarPreviewRenderer:
    ...
    def build_preview_card(
        ...
        draw.rounded_rectangle((margin + 24, 112, margin + 380, 168), radius=22, fill=(22, 48, 70))
        draw.text((margin + 44, 124), "火山数字人 预览模式", fill=(124, 224, 255), font=small_font)

        y = 220
        draw.text((margin, y), "没有接通正式会话时，也能先看见", fill=(255, 255, 255), font=title_font)
        y += 88
