...
| 2.3 Method path | Double coding credibility | `formal_merge/qigong_double_coding_from_web.csv`, `formal_merge/web_reliability/coding_reliability.csv`, `formal_merge/web_reliability/coding_reliability_report.md`, `formal_merge/web_reliability_gate.md`, optional reconciliation workbook | Double-coded subset covers at least 20% of the 120 formal sample; agreement, Cohen's kappa, and nominal Krippendorff's alpha reported for `dominant_frame` and key v0.8 variables |
...
- If `web_reliability_gate.md` has any fail gate, do not report key human-coded variables as formal findings.
