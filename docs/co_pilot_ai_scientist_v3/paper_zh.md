...
7. 一个 OpenReview-guided regeneration probe：初始 3 篇运行中 review-guided 版本 `3/3` 胜出，扩展 6 篇运行中 `5/6` 胜出，mean overall 从 `3.0` 提升到 `3.8333`。
