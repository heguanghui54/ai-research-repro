...
`prospective_matched_fml_causality_20260602_010002` as a full paper-shaped manuscript. The baseline uses
...
MAE 0.335996 and test MAE 0.296399, outperforming the co-pilot
...
-0.349825, so the autonomous run wins on this test metric. This result
