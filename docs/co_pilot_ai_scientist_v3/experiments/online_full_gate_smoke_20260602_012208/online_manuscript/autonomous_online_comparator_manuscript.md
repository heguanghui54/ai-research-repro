...
`online_full_gate_smoke_20260602_012208`. The autonomous run uses benchmark
...
metric is `0.627837` and its held-out
primary test metric is `0.646224`. The
co-pilot online trajectory's selected continuation test metric is
`0.646224`. Lower is better for this
...
`docs/co_pilot_ai_scientist_v3/experiments/online_full_gate_smoke_20260602_012208/autonomous_baseline_summary.json`.
...
`online_full_gate_smoke_20260602_012208`. Its FML component selects a branch with
validation MAE `0.675172` and reports
held-out test MAE `0.646224`.

## 4. Results

| Path | Validation metric | Test primary metric |
| --- | ---: | ---: |
| Co-pilot online trajectory | 0.675172 | 0.646224 |
| Autonomous comparator | 0.627837 | 0.646224 |
...
comparison, the autonomous test metric is `0.646224`
