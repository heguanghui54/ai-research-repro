...
`prospective_matched_fml_causality_20260602_000001` as a full paper-shaped IGRE/co-pilot manuscript.
...
0.602170 and test MAE 0.624703. Lower MAE is better, so the
test delta autonomous-minus-co-pilot is -0.021520. The contribution is
...
> The frontier gate reviewed 2 candidate branches (step_0001 validation score 0.627837; step_0002 validation score 0.627837) and selected `step_0001`. The recorded active review time is 3.0 minutes, and the taste/insight score is 3.57. The qualitative rationale is: The branch choice is scientifically modest but claim-relevant: Causality_causalml directly tests whether frontier steering can be inserted into an AI Scientist-v2 benchmark trajectory.
...
| Matched autonomous baseline | 0.602170 | 0.624703 |
