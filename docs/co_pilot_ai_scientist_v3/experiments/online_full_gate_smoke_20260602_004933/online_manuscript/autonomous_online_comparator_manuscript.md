...
`online_full_gate_smoke_20260602_004933`. The autonomous run uses benchmark
...
metric is `0.602170` and its held-out
primary test metric is `0.624703`. The
...
`online_full_gate_smoke_20260602_004933`. Its FML component selects a branch with
validation MAE `0.627837` and reports
...
| --- | ---: | ---: |
| Co-pilot online trajectory | 0.627837 | 0.646224 |
| Autonomous comparator | 0.602170 | 0.624703 |
...
comparison, the autonomous test metric is `0.624703`
