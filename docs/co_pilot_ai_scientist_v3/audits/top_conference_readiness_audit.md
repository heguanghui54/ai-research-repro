...
| Human taste/insight as distinct from generic approval | Partially supported | IGRE framing, taste rubric, two complete scientific-taste prior gates, taste coverage audit over 39 gates, `human_copilot_trace_dataset.md/json`, and the `nhop/OpenReview` streaming expert-review taste-prior probe over 160 sampled rows from a 34,638-row corpus. | Use OpenReview only as an offline expert-review proxy; stronger evidence needs prospective human interventions and downstream outcomes. |
