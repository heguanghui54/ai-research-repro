...
the sharper remaining priority is blind human expert ratings for paired
mini-manuscripts, inter-rater agreement, and then expanded matched autonomous
versus human-gated runs across more tasks, seeds, and budgets. The paper's
