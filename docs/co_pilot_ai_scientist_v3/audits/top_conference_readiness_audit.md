...
| Reusable Codex skill | Satisfied as artifact | `skills/co-pilot-ai-scientist-v3/SKILL.md` plus templates. | Run an independent clean invocation before calling it production-ready. |
| GitHub push | Satisfied for current branch | Branch `codex/co-pilot-ai-scientist-v3` is pushed to `heguanghui54/ai-research-repro`. | Merge or tag a stable release when the package is ready. |
