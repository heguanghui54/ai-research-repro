...
| AI Scientist-v2-style experiment execution and paper writing | Partially supported | FML-bench runs, matched Causality pairs, generated paper drafts and PDFs. A fresh online full-gate smoke now generates a complete co-pilot manuscript artifact with internal score `4.64`. | Add a matched autonomous manuscript from the same fresh trajectory and scale beyond smoke budgets. |
