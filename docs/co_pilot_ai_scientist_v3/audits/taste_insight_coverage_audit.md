...
- Logs containing any taste/insight object: 2
- Logs with complete taste/insight records: 2
- Logs missing one or more required taste/insight fields: 37
...
| `scientific_taste_prior_attention_measurement_001` | `human_gate_log` | `scientific_taste_prior` | yes | yes | - |
