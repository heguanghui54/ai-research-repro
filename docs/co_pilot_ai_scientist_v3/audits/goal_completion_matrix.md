...
- Audit date: `2026-06-02T15:56:19Z`
- Status: `pass_with_top_conference_gap`
- HEAD: `b867396d1333d39c3eac77699cee2afcafd7cef5`
- Branch: `codex/co-pilot-ai-scientist-v3`
- Remote branch pushed: `True`
- Manifest artifacts: `792`
...
| github_push | achieved | `https://github.com/heguanghui54/ai-research-repro.git`<br>`codex/co-pilot-ai-scientist-v3`<br>`b867396d1333d39c3eac77699cee2afcafd7cef5` | Branch is pushed if remote branch lookup succeeds; publication as a PR/release is separate. | Create a release or PR only when the user wants a public submission package. |
