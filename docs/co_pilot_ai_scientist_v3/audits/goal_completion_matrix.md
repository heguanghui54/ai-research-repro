...
- Audit date: `2026-06-02T15:16:05Z`
- Status: `pass_with_top_conference_gap`
- HEAD: `068f590cce6f5af52ee042a97e569c96145c2c72`
- Branch: `codex/co-pilot-ai-scientist-v3`
- Remote branch pushed: `True`
- Manifest artifacts: `723`
...
| github_push | achieved | `https://github.com/heguanghui54/ai-research-repro.git`<br>`codex/co-pilot-ai-scientist-v3`<br>`068f590cce6f5af52ee042a97e569c96145c2c72` | Branch is pushed if remote branch lookup succeeds; publication as a PR/release is separate. | Create a release or PR only when the user wants a public submission package. |
