...
- Audit date: `2026-06-02T16:04:21Z`
- Status: `pass_with_top_conference_gap`
- HEAD: `b97ec09166aff64bb0e359afa10fcabf313bd65f`
- Branch: `codex/co-pilot-ai-scientist-v3`
- Remote branch pushed: `True`
- Manifest artifacts: `809`
...
| github_push | achieved | `https://github.com/heguanghui54/ai-research-repro.git`<br>`codex/co-pilot-ai-scientist-v3`<br>`b97ec09166aff64bb0e359afa10fcabf313bd65f` | Branch is pushed if remote branch lookup succeeds; publication as a PR/release is separate. | Create a release or PR only when the user wants a public submission package. |
