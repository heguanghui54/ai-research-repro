...
- Audit date: `2026-06-02T15:20:38Z`
- Status: `pass_with_top_conference_gap`
- HEAD: `98652e3950b09033cbb3f606b89b095032717bdc`
- Branch: `codex/co-pilot-ai-scientist-v3`
- Remote branch pushed: `True`
- Manifest artifacts: `747`
...
| github_push | achieved | `https://github.com/heguanghui54/ai-research-repro.git`<br>`codex/co-pilot-ai-scientist-v3`<br>`98652e3950b09033cbb3f606b89b095032717bdc` | Branch is pushed if remote branch lookup succeeds; publication as a PR/release is separate. | Create a release or PR only when the user wants a public submission package. |
