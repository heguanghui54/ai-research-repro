...
- Audit date: `2026-06-02T18:45:58Z`
- Status: `pass_with_top_conference_gap`
- HEAD: `e9defdde0b59bc242ceb728ec76fc274a8ef8eea`
- Branch: `codex/co-pilot-ai-scientist-v3`
- Remote branch pushed: `True`
- Manifest artifacts: `898`
...
| github_push | achieved | `https://github.com/heguanghui54/ai-research-repro.git`<br>`codex/co-pilot-ai-scientist-v3`<br>`e9defdde0b59bc242ceb728ec76fc274a8ef8eea` | Branch is pushed if remote branch lookup succeeds; publication as a PR/release is separate. | Create a release or PR only when the user wants a public submission package. |
