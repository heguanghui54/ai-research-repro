...
| Research-skill and manuscript-copilot workflows | PaperOrchestra; academic-research-skills; Claude-Code-Skills-for-Academics | PaperOrchestra provides a multi-agent paper-writing theory source; academic skill bundles operationalize such writing, review, citation, audit, data, and session-management ideas as reusable workflow modules | IGRE is not primarily a skill bundle; it defines human-insight gates that decide how the research search process should change |
