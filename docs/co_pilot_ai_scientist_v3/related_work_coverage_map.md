...
| Schmidhuber self-referential learning line | 1987 self-referential learning; OOPS; Gödel Machine; POWERPLAY; Darwin Gödel Machine; Huxley-Gödel Machine | Supplies the older discipline of ordered program search, self-modification, verification, archive growth, and competence preservation | IGRE does not optimize the agent's whole source code; it evolves bounded research artifacts, evaluators, subproblem programs, and claim policies under human-insight gates |
