...
| Evaluator-stress trigger-policy analysis | 最佳触发策略 mean balanced accuracy 0.927934 | autonomous 0.924857；always-on gate 0.926426 | 最佳触发策略 delta +0.003077；2 胜、0 负、23 平；触发 5 次 | class-imbalance trigger 保留 imbalance 收益，同时避免 always-on gate 在干净任务上的 overreach 负例。 |
