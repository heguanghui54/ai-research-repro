...
| Prospective matched packages | co-pilot 或人类选分支胜 3 次，其中 SSH Max-Cut mean normalized score 为 0.984419，open-data evaluator-stress mean 为 0.926426 | autonomous / tie / invalid 3 次；SSH Max-Cut autonomous mean 为 0.596214，open-data autonomous mean 为 0.924857 | 6 个 package；SSH Max-Cut delta +0.388205；open-data delta +0.001569 | prospective package 形状、机器可评分 frontier steering 和选择性 evaluator-stress 已能在远程机器上审计，但仍不支持短预算平均 benchmark 优越性。 |
