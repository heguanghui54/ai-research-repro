...
create table if not exists public.coding_submissions (
  ...
  secondary_frames text not null default '',
  body_visibility text not null,
  body_count text not null default 'unclear',
  movement_tempo text not null,
  camera_relation text not null default 'unclear',
  text_occlusion text not null default 'unclear',
  breath_cue text not null default '0',
  mind_cue text not null default '0',
  qi_meridian_cue text not null default '0',
  risk_cue text not null default '0',
  call_to_action text not null default 'unclear',
  platform_trace text not null default 'unclear',
  origin_reference text not null,
  supplement_mode text not null,
  binary_reversal text not null,
  recontextualization_scene text not null default 'unclear',
  ...
  cyber_wellness_symbol text not null default '0',
